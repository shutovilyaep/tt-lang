...
- **Связанные документы**:
  - `docs/sdlc/00_Main/02_Architecture/01_HighLevelDesign.md` (ответственности и инварианты)
  - `docs/sdlc/00_Main/02_Architecture/05_LLD_Testing.md` (архитектура тестов)
